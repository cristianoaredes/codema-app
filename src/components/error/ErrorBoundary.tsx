...
const errorTypeIcons: Record<ErrorInfo['type'], React.ComponentType<{ className?: string }>> = {
  network: Wifi,
...
export function UserError({ errorInfo, className }: { errorInfo: ErrorInfo; className?: string }): JSX.Element {
